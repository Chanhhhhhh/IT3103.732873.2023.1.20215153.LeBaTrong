...
public class DaysOfMonth {
    public static void main(String[] args) {
        ...
        boolean validMonth;
        boolean validYear;
        // vòng lặp để kiểm tra dữ liệu người dùng nhập vào có đúng yêu cầu hay không
        // nếu nhập sai thì sẽ yêu cầu nhập lại
        do {
            ...
            scanner.nextLine();
            validMonth = true;
            // tạo switch/case để kiểm tra từng trường hợp mà người dùng nhập vào
            switch (month) {
